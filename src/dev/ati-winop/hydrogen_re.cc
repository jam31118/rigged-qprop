...
int main(int argc, char **argv) {
  ...
  const double extra_time_winop=para_winop.getDouble("extra-time-winop");
  const double duration=pulse_duration+extra_time_winop;
  ...
  cout << "R_max/T_simulation: " << R_max/duration << endl;
