...
int main(int argc, char **argv) {
  ...
  vecpot vecpot_x(para_prop.getDouble("omega"), para_prop.getDouble("num-cycles"), para_prop.getDouble("max-electric-field"), 0.0);
  vecpot vecpot_y(para_prop.getDouble("omega"), para_prop.getDouble("num-cycles"), para_prop.getDouble("max-electric-field"), 0.5*M_PI);
  vecpot vecpot_z(para_prop.getDouble("omega"), 1.0, 0.0, 0.0);
